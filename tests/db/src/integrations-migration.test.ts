...
describe("Integrations Migration Verification", () => {
  ...
  // Was "…at the manifest tail", pinned to ids.length - 2 / - 1. That assertion
  // could only ever hold until the next migration landed, and 200_expiry_core
  // is that migration. What the integrations context actually needs is that its
  // two migrations stay adjacent and in order, after everything before them —
