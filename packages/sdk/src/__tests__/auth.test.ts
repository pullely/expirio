...
//   - ExpirioError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Expirio {
  return new Expirio({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Expirio class", () => {
