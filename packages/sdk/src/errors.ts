// Typed error hierarchy for the Expirio SDK.
//
...
// codes (forward compatibility) fall back to the generic `ExpirioError`
...
export interface ExpirioErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof ExpirioError`
 * still matches.
 */
export class ExpirioError extends Error {
  ...
  constructor(init: ExpirioErrorInit) {
    super(init.envelope.message);
    this.name = "ExpirioError";
...
export class BadRequestError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class UnauthenticatedError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class ForbiddenError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class NotFoundError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class ConflictError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class ValidationError extends ExpirioError {
...
export class PreconditionFailedError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class UnsupportedError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export class InternalError extends ExpirioError {
  constructor(init: ExpirioErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends ExpirioErrorInit {
...
export class RateLimitError extends ExpirioError {
...
/**
 * Decode an HTTP `Response` into the appropriate `ExpirioError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `ExpirioError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new ExpirioError(init);
  }
}

function decodeRateLimit(
  init: ExpirioErrorInit,
  response: Response,
): RateLimitError {
