// `expirio webhook verify` — local cryptographic verification of a
// Expirio outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `expirio login`.
