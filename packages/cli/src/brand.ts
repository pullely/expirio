...
// `@saas/sdk` client class name (`Expirio`) is intentionally NOT part of
...
export const CLI_BIN = "expirio";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Expirio";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.expirio.app";
