...
//   - `~/.config/expirio/credentials.json` (0600)
//   - `~/.config/expirio/config.json`     (0644)
//
// Override via `EXPIRIO_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/expirio` everywhere
