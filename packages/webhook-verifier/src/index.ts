 ...
 * signature verifier for Expirio outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Expirio webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Expirio webhook delivery.
 *
