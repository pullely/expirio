...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Expirio web console.
...
- Per-env Cloudflare Pages projects: `expirio-web-console-next-{dev,stage,prod}`
